                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($student['jr']['status'] === "Pending")
                                            <a class="badge badge-primary" href="{{ route('admin.course.student.approve', ['id' => $course->id(), 'user_id' => $student['jr']['student_id']]) }}">Approve</a>
                                            <a class="badge badge-danger" href="{{ route('admin.course.student.reject', ['id' => $course->id(), 'user_id' => $student['jr']['student_id']]) }}">Reject</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
