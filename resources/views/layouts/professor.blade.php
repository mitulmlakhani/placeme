                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item {{ \Request::is('professor/course/create') ? 'active' : '' }}" href="{{ route('professor.course.create') }}">
                                    Create
                                </a>
                                <a class="dropdown-item {{ \Request::is('professor/course') ? 'active' : '' }}" href="{{ route('professor.course.index') }}">
                                    List
                                </a>
                            </div>
                        </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if(session()->has('auth') == false)
                            <li class="nav-item">
                                <a class="nav-link {{ \Request::is('professor/login') ? 'active' : '' }}" href="{{ route('professor.login') }}">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link {{ \Request::is('professor/register') ? 'active' : '' }}" href="{{ route('professor.register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('professor.profile') }}">Profile</a>
